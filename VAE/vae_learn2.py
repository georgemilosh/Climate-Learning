...
def kwargator(thefun):
    ...
    thefun_kwargs_default = ut.set_values_recursive(thefun_kwargs_default,
                                            {'myinput':'Y', 'lat_end': 24,'fields': ['t2m_inter_filtered','zg500_inter','mrso_inter_filtered'], 'label_field' : 't2m_inter', 'year_list': 'range(500)', 'T' : 15,
                                               'print_summary' : False, 'k1': 0.9 , 'k2':0.1, 'field_weights': [20., 1., 20.],'mask_area':'France', 'usemask' : True, 'Z_DIM': 64, #16, #8, #64,
