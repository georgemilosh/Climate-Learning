...
for new_metric, metric_label in zip([new_MCC[:,:,iui:],new_skill[:,:,iui:], new_F1[:,:,iui:],new_TPR[:,:,iui:], new_PPV[:,:,iui:], new_Brier_skill[:,:,iui:], new_BS[:,:,iui:]],['MCC','skill', 'F1','recall','precision', 'BrierSkill','Brier']):
